      ...
      ******************************************************************
       ...
       FD EMPLEADOS-ARCHIVO.
           01 EMPLEADOS-REGISTRO.
              ...
              05 EMPLEADOS-TELEFONO PIC X(35).
              05 EMPLEADOS-DIRECCION PIC X(35).

       WORKING-STORAGE SECTION.
           01  IDENTIFICADOR PIC X(36)  VALUE "id: ".
           01  NOMBRE PIC X(33) VALUE "Introduce un nombre: ".
           01  APELLIDOS PIC X(25) VALUE "Itroduce apelldo".
	          01  EDAD PIC X(19) VALUE "Introduce la edad:".
	          01  TELEFONO PIC X(33)
           VALUE "Introduce un número de teléfono: ".
	          01  DIRECCION PIC X(25) VALUE "Introduce una n: ".
	          01  SI-NO PIC X.
	          01  ENTRADA PIC X.
